...
parser.add_argument('--decoder-dropout', type=float, default=0.0,
                    help='Dropout rate (1 - keep probability).')
parser.add_argument('--save-folder', type=str, default='saved_models',
...
parser.add_argument('--timesteps', type=int, default=450,
...
train_loader,valid_loader,test_loader = load_neuron_data(args.batch_size, args.split * args.timesteps, args.num_atoms, args.dims, split = args.split, train_only = False)
...
if args.prior:
    prior = np.array([0.94, 0.03, 0.03])  # TODO: hard coded for now
    print("Using prior")
    print(prior)
